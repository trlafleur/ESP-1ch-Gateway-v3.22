...
#define _SPREADING SF7							// Send and receive on this Spreading Factor (only)  // <-----------TRL
...
#define AP_NAME "ESP8266-TTN-Gway"
...
#define _TTNSERVER "router.us.thethings.network"        //  <----------- trl
...
#define _EMAIL "tom@lafleur.us"   //  <----------- trl
